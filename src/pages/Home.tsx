    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
            <h1 className="text-5xl md:text-7xl font-bold text-foreground leading-tight">
              Bem-vindo ao{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">LUMINA</span>
            </h1>
      ...
      <section className="py-20 px-4 bg-card/50">
        <div className="container mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-foreground">Recursos Principais</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-card p-6 rounded-lg border border-border hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/10 animate-slide-up">
              ...
              <p className="text-muted-foreground">Acesse e organize todos os materiais de estudo em um só lugar</p>
            </div>

            {/* Feature 2 */}
            <div
              className="bg-card p-6 rounded-lg border border-border hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/10 animate-slide-up"
            ...
            >
              ...
              <p className="text-muted-foreground">Professores e alunos conectados de forma simples e eficiente</p>
            </div>
            ...
            >
              ...
              <p className="text-muted-foreground">Assistente inteligente para professores e alunos</p>
            </div>
            ...
            >
              ...
              <p className="text-muted-foreground">Seus dados protegidos com tecnologia de ponta</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center bg-gradient-to-br from-card to-card/50 p-12 rounded-2xl border border-border shadow-2xl">
            ...
            <p className="text-xl text-muted-foreground mb-8">Junte-se a plataforma que te entende</p>
            <Button
              size="lg"
      ...
      <footer className="py-8 px-4 border-t border-border">
        <div className="container mx-auto text-center">
          <p className="text-muted-foreground">© 2025 LUMINA - Plataforma Acadêmica</p>
        </div>
      </footer>
    </div>
  );
